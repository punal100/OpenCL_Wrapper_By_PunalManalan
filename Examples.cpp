...
int Example3()
{
	...
	//Device Number 0 for first Device, Argument Number 0 for first Argument and Buffer 0(the 1st Buffer) For each Arugment
	MultiDeviceData.StoreDataForKernelArgument(0, 0, 1, IntA, 5 * sizeof(int), Issuccessful, true, false);
	MultiDeviceData.StoreDataForKernelArgument(0, 1, 1, IntB, 5 * sizeof(int), Issuccessful, true, false);
	MultiDeviceData.StoreDataForKernelArgument(0, 2, 1, IntC, 5 * sizeof(int), Issuccessful, true, false);
