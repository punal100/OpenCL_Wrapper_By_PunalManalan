...
int Example4()
{
	...
	EntireOpenCLProgram.InterchangeBufferWithinSameDevice(0, 0, 0, 0, 1, 0, 0, Issuccessful);//Inter Changing Arugment0Buffer1 of Kernel1(Add) with Arugment0Buffer1 of Kernel2(Sub)
	EntireOpenCLProgram.InterchangeBufferWithinSameDevice(0, 0, 1, 0, 1, 1, 0, Issuccessful);//Inter Changing Arugment1Buffer1 of Kernel1(Add) with Arugment1Buffer1 of Kernel2(Sub)	
